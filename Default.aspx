...
<script runat="server">
    ...
    protected void btnMakeDirectory_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Directory.Exists(path))
            {
                lblInfo.Text = "Temp path already exists.";
            }
            else
            {
    ...
    protected void btnDeleteDirectory_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            // Check if directory exitss
            if (Directory.Exists(path))
            {
                // Delete directory
                Directory.Delete(path, true);

                // This code refreshes the page
                Page.Response.Redirect(HttpContext.Current.Request.Url.ToString(), true);

                lblInfo.Text = "Temp directory was deleted successfully.";
        ...
        try
        {
            ...
            if (FileUpload1.HasFile)
            {
                if (Directory.Exists(path))
                {
                    ...
                    string fileName = Server.MapPath(".") + "\\temp\\" + FileUpload1.FileName.ToString();
    ...
    protected void btnSubmit_sql_Click(Object sender, EventArgs e)
    {
        try
        {
            ...
            //string ConnectionString = "Server=72.3.140.177,4193;Database=393014_netagents;Uid=dreamingcodedb;Pwd=dr3code09#";
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
            <br />
            To ensure this test works correctly please ensure that <a href="http://www.rackspace.com/knowledge_center/index.php/How_do_I_add_impersonation_to_my_ASP.NET_site"
                target="_blank">impersonation</a> is enabled
        <br />
            via web.config in the system.web class:
        <br />
            <br />
